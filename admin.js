...
(function() {
  ...
  jQuery(function() {
    ...
    jQuery(".master_link_row input[data-validation]").live("keyup", function(event) {
      var input;
      input = event.target;
      return checkValidation(input);
    });
    jQuery(".master_link_row select").live("change", function(event) {
  ...
  setupSortable = function() {
    return jQuery("table.sortable tbody#here").sortable().disableSelection();
  };
